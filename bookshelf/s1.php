...
// Initialize the bookshelf array in the session if not already set
if (!isset($_SESSION['book_info'])) {
    $_SESSION['book_info'] = array();
}

// Function to check if a book is in the bookshelf
function isInBookshelf($productId) {
    return in_array($productId, $_SESSION['book_info']);
}
?>
        ...
        <div class="card">
            <div class="card-main">
             ...
             <div class="button-wrapper">
                ...
                <?php if(!$isInBookshelf){
                    ?>
                    <form action="addToBookshelf.php" method ="post">
                    <input type="hidden" name="book_id" value="<?php echo $productId; ?>">
                        <button class="btn fill" type="submit">ADD TO BOOKSHELF</button>
                    </form>  
                    <?php } else  { ?>
                    <button class="btn outline" disabled>Already in Bookshelf</button>
                <?php } ?>
